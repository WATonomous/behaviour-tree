...
class Root(py_trees.composites.Selector):
    ...
    def setup(self):
        ...
        self.blackboard.current_pos = [0, 0]   # Starting position of the car
        self.blackboard.goal_pos = [10, 10]    # Goal position for the car
        self.blackboard.route_list = [[1, 1], [5, 5], [10, 10]]  # Example route with 3 nodes
